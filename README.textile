...
"oui_player_vine":https://github.com/NicolasGraph/oui_player_vine is a "oui_player":https://github.com/NicolasGraph/oui_player v2+ extension to easily embed "Vine":https://vine.go.com/ provided videos in "Textpattern":https://textpattern.com/ powered websites.
...
oui_player_vine's minimum requirements:
...
# "Download":https://github.com/NicolasGraph/oui_player_vine/releases the compiled plugin file or the source to compile a customized file.
...
# Install oui_player_vine:
@$ composer require oui/oui_player_vine@
...
bc. $ composer update oui/oui_player_vine
...
bc. $ composer remove oui/oui_player_vine
...
oui_player_vine version 1.0.0, Copyright (C) 2018 Nicolas Morand
...
* *oui_player_vine v1.0.0-beta* (2018-06-24)
